 ...
 */
static char *font = "Cascadia Mono NF:size=15:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] = {
...
static const char *colorname[] = {
	/* 8 normal colors - Catppuccin Mocha */
	...
	/* 8 bright colors */
	"#585b70", /* brblack   (Surface2) */
	"#f38ba8", /* brred     (Red) */
	"#a6e3a1", /* brgreen   (Green) */
	"#f9e2af", /* bryellow  (Yellow) */
	"#89b4fa", /* brblue    (Blue) */
	"#f5c2e7", /* brmagenta (Pink) */
	"#94e2d5", /* brcyan    (Teal) */
	"#a6adc8", /* brwhite   (Subtext0) */

	[255] = 0,

	/* more colors can be added after 255 to use with DefaultXX */
	"#f5e0dc", /* cursor (Rosewater) */
	"#313244", /* reverse cursor (Surface0) */
	"#cdd6f4", /* default foreground colour (Text) */
	"#1e1e2e", /* default background colour (Base) */
};
